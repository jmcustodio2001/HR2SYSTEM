...
<head>
    <title>Travel & Tours Admin Sign In</title>
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center" style="min-height: 80vh;">
                <div class="col-md-7 col-lg-6">
                    ...
                    <form class="md-float-material form-material" method="POST" action="{{ url('/employee-sign-in') }}">
                        @csrf
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="text-center mb-4">
                                    <img src="{{ asset('assets/images/hr2logo.png') }}"alt="Travelogix Logo" style="max-width: 320px; width: 60%; height: auto; min-width: 180px; min-height: 120px; object-fit: contain;">
                                </div>
